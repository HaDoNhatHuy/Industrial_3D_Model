...
export const TABS = [
  {
    ...
    color: "#37474f",
    modelFile: "nha-xuong(test).glb",
    focusCamera: true,
    focusCameraOffset: [0.7, 0.34, 0.78],
    focusDistanceMultiplier: 1.52,
    focusTargetYRatio: 0.46,
    minDistance: 4.2,
    lockPan: true,
  ...
  },
  {
    ...
    labelEn: "Chemical",
    color: "#1565c0",
    modelFile: "bonchua(test2).glb",
    focusCamera: true,
    focusCameraOffset: [0.72, 0.36, 0.78],
    focusDistanceMultiplier: 1.5,
    focusTargetYRatio: 0.43,
    minDistance: 4,
    lockPan: true,
  ...
  },
  {
    ...
    fitSize: 24,
    fitIgnoreMeshNames: ["G-Object.006", "G-Object.007", "G-V-Ray IES Light"],
    fitNameIncludes: ["nha sx chinh", "nha hanh", "C-be chua nuoc"],
    focusNameIncludes: ["nha sx chinh", "nha hanh", "C-be chua nuoc"],
    focusCamera: true,
    focusCameraOffset: [0.7, 0.4, 0.8],
    focusDistanceMultiplier: 1.65,
    focusTargetYRatio: 0.42,
    minDistance: 10,
    lockPan: true,
    clarityMode: true,
    clarityTint: "#8fa2ae",
    clarityTintStrength: 0.82,
    edgeOverlay: true,
    edgeColor: "#324a5a",
    edgeOpacity: 0.44,
    edgeThresholdAngle: 28,
    fogNear: 130,
    fogFar: 420,
